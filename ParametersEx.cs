...
{
    internal class ManagementAgentParametersEx
    {
        internal static void Get(Type managementAgentType, Assembly library)
        {
            var interfaceName = "IMAExtensible2GetParametersEx";
            ...
            var getConfigParamsExMethod = managementAgentType.GetMethod("GetConfigParametersEx");
            var args = new object[] { configParameterKeyedCollection, globalConfigParameterPage, 1 };
